...
export default function App() {
  ...
  const addDepartemenAnggota = (departemenIndex: number) => {
    setFormData(prev => {
      ...
      setHighlightedItem({
        listName: `departemenAnggota-${departemenIndex}`,
        index: updatedDepartemen[departemenIndex].anggota.length - 1,
      });
    ...
    setTimeout(() => {
      const newRef =
        anggotaDepartemenRefs.current[
          departemenIndex * 100 +
            formData.departemen[departemenIndex].anggota.length
        ];
      if (newRef) {
        newRef.focus();
        newRef.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
  ...
  const addLembagaAnggota = (lembagaIndex: number) => {
    setFormData(prev => {
      ...
      setHighlightedItem({
        listName: `lembagaAnggota-${lembagaIndex}`,
        index: updatedLembaga[lembagaIndex].anggota_lembaga.length - 1,
      });
    ...
    setTimeout(() => {
      const newRef =
        anggotaLembagaRefs.current[
          lembagaIndex * 100 +
            formData.lembaga[lembagaIndex].anggota_lembaga.length
        ];
      if (newRef) {
        newRef.focus();
        newRef.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
  ...
  const addCbpDivisiAnggota = (divisiIndex: number) => {
    setFormData(prev => {
      ...
      setHighlightedItem({
        listName: `cbpDivisiAnggota-${divisiIndex}`,
        index: updatedDivisi[divisiIndex].anggota_divisi.length - 1,
      });
      return {
        ...prev,
        cbp: { ...prev.cbp, divisi: updatedDivisi },
    ...
    setTimeout(() => {
      const newRef =
        anggotaCbpDivisiRefs.current[divisiIndex]?.[
          formData.cbp.divisi[divisiIndex].anggota_divisi.length
        ];
      if (newRef) {
        newRef.focus();
        newRef.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setMessage({
        text: 'Surat berhasil dibuat dan diunduh!',
        type: 'success',
      });
    } catch (error) {
  ...
  const TrashIcon = () => (
    ...
    >
      <path
        ...
        d='M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.924a2.25 0 01-2.244-2.077L4.74 5.69c-.32-.052-.65-.107-.98-.166M5.25 9V7.5A2.25 2.25 0 017.5 5.25h9A2.25 2.25 0 0119.5 7.5V9m-9-2.25h.008v.008H10.5V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z'
      />
    </svg>
  );
    ...
    <form onSubmit={handleSubmit} className='space-y-8 w-full'>
      ...
      <details open>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.pelindung.length === 0 ||
          (formData.pelindung.length === 1 &&
            formData.pelindung[0].nama.trim() === '') ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan pelindung pertama Anda.
            </p>
          ) : null}
          {formData.pelindung.map((item, index) => (
            <div
              ...
              className={`flex items-center gap-4 mb-2 ${
                highlightedItem?.listName === 'pelindung' &&
                highlightedItem?.index === index
            ...
            >
              <Input
                ...
                isDisabled={loading}
                description={
                  index === formData.pelindung.length - 1
                    ? 'Tekan Enter untuk menambah baris baru'
                    : ''
                }
              />
              <Button
                ...
                isDisabled={
                  (formData.pelindung.length <= 1 && item.nama.trim() === '') ||
                  loading
                }
              >
                <TrashIcon /> Hapus
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.pembina.length === 0 ||
          (formData.pembina.length === 1 &&
            formData.pembina[0].nama.trim() === '') ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan pembina pertama Anda.
            </p>
          ) : null}
          {formData.pembina.map((item, index) => (
            <div
              key={`pembina-${index}`}
              className={`flex items-center gap-4 mb-2 ${
                highlightedItem?.listName === 'pembina' &&
                highlightedItem?.index === index
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
              <Input
                ...
                isDisabled={loading}
                description={
                  index === formData.pembina.length - 1
                    ? 'Tekan Enter untuk menambah baris baru'
                    : ''
                }
              />
              <Button
                ...
                isDisabled={
                  (formData.pembina.length <= 1 && item.nama.trim() === '') ||
                  loading
                }
              >
                <TrashIcon /> Hapus
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.wakil_ketua.length === 0 ||
          (formData.wakil_ketua.length === 1 &&
            formData.wakil_ketua[0].nama.trim() === '') ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan wakil ketua pertama Anda.
            </p>
          ) : null}
          {formData.wakil_ketua.map((item, index) => (
            <div
              ...
              className={`flex items-center gap-4 mb-2 ${
                highlightedItem?.listName === 'wakil_ketua' &&
                highlightedItem?.index === index
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
              <Input
                ...
                isDisabled={loading}
                description={
                  index === formData.wakil_ketua.length - 1
                    ? 'Tekan Enter untuk menambah baris baru'
                    : ''
                }
              />
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.wakil_sekretaris.length === 0 ||
          (formData.wakil_sekretaris.length === 1 &&
            formData.wakil_sekretaris[0].nama.trim() === '') ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan wakil sekretaris pertama Anda.
            </p>
          ) : null}
          {formData.wakil_sekretaris.map((item, index) => (
            <div
              ...
              className={`flex items-center gap-4 mb-2 ${
                highlightedItem?.listName === 'wakil_sekretaris' &&
                highlightedItem?.index === index
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
              <Input
                ...
                isDisabled={loading}
                description={
                  index === formData.wakil_sekretaris.length - 1
                    ? 'Tekan Enter untuk menambah baris baru'
                    : ''
                }
              />
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.wakil_bendahara.length === 0 ||
          (formData.wakil_bendahara.length === 1 &&
            formData.wakil_bendahara[0].nama.trim() === '') ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan wakil bendahara pertama Anda.
            </p>
          ) : null}
          {formData.wakil_bendahara.map((item, index) => (
            <div
              ...
              className={`flex items-center gap-4 mb-2 ${
                highlightedItem?.listName === 'wakil_bendahara' &&
                highlightedItem?.index === index
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
              <Input
                ...
                isDisabled={loading}
                description={
                  index === formData.wakil_bendahara.length - 1
                    ? 'Tekan Enter untuk menambah baris baru'
                    : ''
                }
              />
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.departemen.length === 0 ||
          (formData.departemen.length === 1 &&
            formData.departemen[0].departemen.trim() === '' &&
            formData.departemen[0].koordinator.trim() === '' &&
            formData.departemen[0].anggota.every(a => a.nama.trim() === '')) ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
          ...
          {formData.departemen.map((dep, depIndex) => (
            <Card
              ...
              className={`p-4 mb-4 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 relative ${
                highlightedItem?.listName === `departemen-${depIndex}` &&
                highlightedItem?.index === depIndex
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
                ...
                <Button
                  ...
                  isDisabled={
                    (formData.departemen.length <= 1 &&
                      dep.departemen.trim() === '' &&
                      dep.koordinator.trim() === '' &&
                      dep.anggota.every(a => a.nama.trim() === '')) ||
                    loading
                  }
              ...
              <div className='ml-4 border-l pl-4'>
                ...
                {dep.anggota.length === 0 ||
                (dep.anggota.length === 1 &&
                  dep.anggota[0].nama.trim() === '') ? (
                  <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
                    Tambahkan anggota departemen pertama Anda.
                  </p>
                ) : null}
                {dep.anggota.map((anggota, anggotaIndex) => (
                  <div
                    ...
                    className={`flex items-center gap-4 mb-2 ${
                      highlightedItem?.listName ===
                        `departemenAnggota-${depIndex}` &&
                      highlightedItem?.index === anggotaIndex
                        ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                        : ''
                    }`}
                  >
                    <Input
                      ...
                      isDisabled={loading}
                      description={
                        anggotaIndex === dep.anggota.length - 1
                          ? 'Tekan Enter untuk menambah baris baru'
                          : ''
                      }
                    />
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          {formData.lembaga.length === 0 ||
          (formData.lembaga.length === 1 &&
            formData.lembaga[0].lembaga.trim() === '' &&
            formData.lembaga[0].direktur.trim() === '' &&
            formData.lembaga[0].sekretaris_lembaga.trim() === '' &&
            formData.lembaga[0].anggota_lembaga.every(
              a => a.nama.trim() === ''
            )) ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan lembaga pertama Anda.
            </p>
          ) : null}
          {formData.lembaga.map((lem, lemIndex) => (
            <Card
              ...
              className={`p-4 mb-4 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 relative ${
                highlightedItem?.listName === `lembaga-${lemIndex}` &&
                highlightedItem?.index === lemIndex
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
                ...
                <Button
                  ...
                  isDisabled={
                    (formData.lembaga.length <= 1 &&
                      ...
                      lem.direktur.trim() === '' &&
                      lem.sekretaris_lembaga.trim() === '' &&
                      lem.anggota_lembaga.every(a => a.nama.trim() === '')) ||
                    loading
                  }
                  className='absolute top-2 right-2'
                >
              ...
              <div className='ml-4 border-l pl-4'>
                ...
                {lem.anggota_lembaga.length === 0 ||
                (lem.anggota_lembaga.length === 1 &&
                  lem.anggota_lembaga[0].nama.trim() === '') ? (
                  <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
                    Tambahkan anggota lembaga pertama Anda.
                  </p>
                ) : null}
                {lem.anggota_lembaga.map((anggota, anggotaIndex) => (
                  ...
                  >
                    <Input
                      ...
                      isDisabled={loading}
                      description={
                        anggotaIndex === lem.anggota_lembaga.length - 1
                          ? 'Tekan Enter untuk menambah baris baru'
                          : ''
                      }
                    />
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        removeLembagaAnggota(lemIndex, anggotaIndex)
                      }
                      isDisabled={
                        (lem.anggota_lembaga.length <= 1 &&
                          anggota.nama.trim() === '') ||
      ...
      <details>
        ...
        <Card className='p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 mt-2'>
          ...
          <div className='ml-4 border-l pl-4 mb-4'>
            ...
            {formData.cbp.wakil_komandan.length === 0 ||
            (formData.cbp.wakil_komandan.length === 1 &&
              formData.cbp.wakil_komandan[0].nama.trim() === '') ? (
              <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
                Tambahkan wakil komandan pertama Anda.
              </p>
            ) : null}
            {formData.cbp.wakil_komandan.map((item, index) => (
              <div
                ...
                className={`flex items-center gap-4 mb-2 ${
                  highlightedItem?.listName === 'cbp-wakil_komandan' &&
                  highlightedItem?.index === index
                    ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                    : ''
                }`}
              >
                <Input
                  ...
                  isDisabled={loading}
                  description={
                    index === formData.cbp.wakil_komandan.length - 1
                      ? 'Tekan Enter untuk menambah baris baru'
                      : ''
                  }
                />
                <Button
                  ...
                  size='sm'
                  onClick={() =>
                    removeCbpSimpleListItem('wakil_komandan', index)
                  }
                  isDisabled={
                    (formData.cbp.wakil_komandan.length <= 1 &&
                      item.nama.trim() === '') ||
          ...
          {/* CBP Divisi manual */}
          {formData.cbp.divisi.length === 0 ||
          (formData.cbp.divisi.length === 1 &&
            formData.cbp.divisi[0].divisi.trim() === '' &&
            formData.cbp.divisi[0].kepala.trim() === '' &&
            formData.cbp.divisi[0].anggota_divisi.every(
              a => a.nama.trim() === ''
            )) ? (
            <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
              Tambahkan divisi CBP pertama Anda.
            </p>
          ) : null}
          {formData.cbp.divisi.map((div, divIndex) => (
            <Card
              ...
              className={`p-4 mb-4 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 relative ${
                highlightedItem?.listName === `cbpDivisi-${divIndex}` &&
                highlightedItem?.index === divIndex
                  ? 'transition-all duration-300 bg-yellow-100 dark:bg-yellow-900 rounded-md p-2'
                  : ''
              }`}
            >
                ...
                <Button
                  ...
                  isDisabled={
                    (formData.cbp.divisi.length <= 1 &&
                      div.divisi.trim() === '' &&
                      div.kepala.trim() === '' &&
                      div.anggota_divisi.every(a => a.nama.trim() === '')) ||
                    loading
                  }
                  className='absolute top-2 right-2'
                >
              ...
              <div className='ml-4 border-l pl-4'>
                ...
                {div.anggota_divisi.length === 0 ||
                (div.anggota_divisi.length === 1 &&
                  div.anggota_divisi[0].nama.trim() === '') ? (
                  <p className='text-gray-500 dark:text-gray-400 text-sm mb-4'>
                    Tambahkan anggota divisi pertama Anda.
                  </p>
                ) : null}
                    ...
                    <Input
                      ...
                      ref={el => {
                        anggotaCbpDivisiRefs.current[divIndex] =
                          anggotaCbpDivisiRefs.current[divIndex] || [];
                        anggotaCbpDivisiRefs.current[divIndex][anggotaIndex] =
                          el;
                      }}
                      onKeyDown={e => {
                        if (e.key === 'Enter') {
                      ...
                      isDisabled={loading}
                      description={
                        anggotaIndex === div.anggota_divisi.length - 1
                          ? 'Tekan Enter untuk menambah baris baru'
                          : ''
                      }
                    />
