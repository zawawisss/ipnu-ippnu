...
export default function AdminKomisariatPage() { // Renamed from AdminDesaContent for clarity as it manages Komisariat
  return (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:border-gray-700">
          ...
          <div className="rounded-lg overflow-hidden">
            ...
            <Suspense fallback={<div>Loading Komisariat data...</div>}>
                <SekolahDataAdmin /> {/* No need to pass searchParams directly here. SekolahDataAdmin will use useSearchParams internally. */}
            </Suspense>
          </div>
        </div>
    </section>
