...
const ArsipSuratMasukPage = () => {
    ...
    const delayDebounceFn = setTimeout(() => {
      const fetchArsipMasuk = async () => {
        ...
        try {
          ...
          setArsipMasukData(data.map((item: ArsipMasuk) => ({ ...item, isEditing: false })));
        } catch (err: any) {
  ...
  return (
    <div className="container mx-auto p-4 dark:text-gray-200">
      <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-200">Arsip Surat Masuk</h1>
      ...
      {loading ? (
        ...
        <p className="text-gray-600 dark:text-gray-400">Tidak ada data arsip surat masuk.</p>
      ) : (
                  ...
                  <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                    {surat.isEditing ? (
                      <input
                        ...
                        onChange={(e) => handleInputChange(e, surat._id, 'pengirim')}
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-200 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700"
                      />
                    ) : (
                      surat.pengirim
                  ...
                  <td className="py-4 px-6 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                    {surat.isEditing ? (
                      <input
                        ...
                        onChange={(e) => handleInputChange(e, surat._id, 'tanggal_surat')}
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-200 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700"
                      />
                    ) : (
                      surat.tanggal_surat
