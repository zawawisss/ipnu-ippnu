...
const jenjangKaderOptions = [
  ...
  // Pengkaderan Non-Formal untuk IPPNU
  { key: 'LATPEL', label: 'Latihan Pelatih (LATPEL)' }
];
...
const AdminIPPNUKaderisasiPage: React.FC = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ ...formData, organization: 'IPPNU' })
      });
    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <Card>
        <CardBody className="p-0">
          <Table aria-label="Tabel Data Kaderisasi IPPNU">
            <TableHeader>
...
export default AdminIPPNUKaderisasiPage;
